...
//! # Usage
//! ```bash
//! cargo run -p kvbm-memory --bin inspect_resources --features host-pools
//! cargo run -p kvbm-memory --bin inspect_resources --features host-pools -- --visible-only
//! ```

use std::process;

use kvbm_memory::resources::{Resources, SlicingMode};
